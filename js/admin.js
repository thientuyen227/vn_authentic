$(document).ready(function() {
            ...
            function displayOrders() {
                ...
                allOrders.forEach((order, index) => {
                            ...
                            const orderHtml = `
                <div class="card mb-3" data-order-index="${index}">
        ...
        "vi-VN"
                    ...
                    <div class="card-body">
                        ...
                        <div class="order-total mt-2">
                            <strong>Tổng cộng:</strong> ${formatCurrency(
                              order.total
                            )}
                        </div>
                        <div class="edit-form">
                            ...
                            <button class="btn btn-sm btn-success save-status mt-2" data-order-index="${index}">Lưu</button>
                        </div>
                    </div>
                </div>
            `;
    ...
    $(".save-status").on("click", function () {
      ...
      const newStatus = $(`#status-${orderIndex}`).val();
      const userOrdersKey = users.find((key) =>
        JSON.parse(localStorage.getItem(key)).some(
          (o) => o.date === allOrders[orderIndex].date
        )
      );
